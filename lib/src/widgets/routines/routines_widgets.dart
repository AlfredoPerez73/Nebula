...
class RoutineWidgets {
  final EntrenamientoController controller;
  ...
  RoutineWidgets({
    ...
    required this.diasSemanaCortos,
    required this.diasSemanaCompletos,
  });

  // FAB Mejorado
  Widget buildEnhancedFloatingButton(BuildContext context) {
    return Container(
  ...
  Widget buildEnhancedAppBar(BuildContext context) {
    return Container(
  ...
  Widget buildEnhancedLoadingState() {
    return Center(
      child: Column(
  ...
  // Confirmar borrar todos los ejercicios
