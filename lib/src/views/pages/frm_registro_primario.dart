...
class RegisterPrimaryPage extends StatefulWidget {
  const RegisterPrimaryPage({Key? key}) : super(key: key);

  @override
  State<RegisterPrimaryPage> createState() => _RegisterPrimaryPageState();
}

class _RegisterPrimaryPageState extends State<RegisterPrimaryPage> {
