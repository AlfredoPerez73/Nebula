...
import 'package:nebula/src/widgets/workout_display_widget.dart';
import 'package:nebula/src/widgets/workout_loading_dialog.dart';
import 'package:nebula/src/widgets/workout_selector_dialog.dart';
...
// Home content for index 0
  ...
  Widget _buildPremiumProgressCard({
    ...
    return Container(
      ...
      child: Column(
        children: [
          // Parte superior con fondo de cristalF
          Container(
            padding: const EdgeInsets.all(20),
            decoration: BoxDecoration(
